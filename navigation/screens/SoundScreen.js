  ...
  renderItem = ({item}) => (
    <ListItem bottomDivider>
      ...
      <ListItem.Content style={styles.item}>
        <ListItem.Title style={styles.title_text} ellipsize='tail' numberOfLines={1}>{item.get('title')}</ListItem.Title>
        <ListItem.Subtitle style={styles.artist_text}>{item.get('artist')}</ListItem.Subtitle>
        <ListItem.Subtitle style={styles.views_text}>{item.get('views')}</ListItem.Subtitle>
      </ListItem.Content>
    </ListItem>
  )
